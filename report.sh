...
echo "* [Keycloak QuickStarts CI: ![GitHub Workflow Status (event)](https://img.shields.io/github/workflow/status/keycloak/keycloak-quickstarts/Quickstarts%20tests?event=schedule)](https://github.com/keycloak/keycloak-quickstarts/actions?query=event%3Aschedule)"
echo ""
